...
static NSString *domainString = @"com.pabloecab.popuponstart";
static NSString *notificationString = @"com.pabloecab.popuponstart/preferences.changed";
...
static NSString *titleText = @"PopupOnStart";
static NSString *messageText = @"Jailbreak succeeded!";
static NSString *cancelText = @"OK";
